...
buildrust:
	cd rust && cargo build --release --target armv7a-none-eabi
...
$(OUTELF): $(ALLOBJS) $(LINKER_SCRIPT) buildrust
	@echo linking $@
	$(NOECHO)$(LD) $(LDFLAGS) -T $(LINKER_SCRIPT) $(ALLOBJS) rust/target/armv7a-none-eabi/release/librust.a $(LIBGCC) -Map=$(OUTELF).map -o $@
endif
